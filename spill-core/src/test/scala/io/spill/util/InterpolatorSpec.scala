...
class InterpolatorSpec extends Spec {
  ...
  "traces small objects on single line - single" in {
    trace"small object: $small"
      .generateString() mustEqual (("small object: Small(123) ", 0))
  }

  "traces multiple small objects on single line" in {
    trace"small object: $small and $small".generateString() mustEqual (
      (
        "small object: Small(123) and Small(123) ",
        0
      )
    )
  }
...
and bar $small""".generateString() mustEqual (("""small object:
        ||  Small(123)
        ||and foo
        ||and bar
        ||  Small(123)
  ...
  "traces large objects on multiple line - single" in {
    trace"large object: $large"
      .generateString() mustEqual (("""large object:
        ||  Large(
        ||    123,
        ||    "",
        ||    "Test",
  ...
  "traces large objects on multiple line - multi" in {
    trace"large object: $large and $large"
      .generateString() mustEqual (("""large object:
        ||  Large(
        ||    123,
        ||    "",
