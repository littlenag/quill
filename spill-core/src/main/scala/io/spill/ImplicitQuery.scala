...
trait ImplicitQuery {
  ...
  implicit def toQuery[P <: Product](f: AbstractFunction1[_, P]): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](f: AbstractFunction2[_, _, P]): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction3[_, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction4[_, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction5[_, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction6[_, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction7[_, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction8[_, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction9[_, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction10[_, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction11[_, _, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction12[_, _, _, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction13[_, _, _, _, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction14[_, _, _, _, _, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction15[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
    f: AbstractFunction16[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P]
  ): Stream[P] = macro ImplicitQueryMacro.toQuery[P]
  implicit def toQuery[P <: Product](
